...
public class PageSwitcher {
    ...
    public PageSwitcher() {
        ...
        JFrame frame = new JFrame("F1 Quiz");
        ...
        containerPanel.add(new LoginPage(containerPanel, cardLayout), "LoginPage");
        containerPanel.add(new PlaySetupPage(containerPanel, cardLayout), "Setup");
